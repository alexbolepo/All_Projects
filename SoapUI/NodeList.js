  ...
  */
  ...
  session.input.readAsBuffer(function (readAsBufferError, data) {
    if (readAsBufferError) {
     ...
     var specifyJson = JSON.stringify(content);
     var lines = content.split(/\r\n|\n|\r/);
     console.alert('alert on readAsBuffer 1: ' + specifyJson);
     ...
     console.alert('alert on readAsBuffer 2: ' + lines);
     console.alert('alert on readAsBuffer 3: ' + lines);
